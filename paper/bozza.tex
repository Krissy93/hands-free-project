...
\begin{table}[]
	...
	\resizebox{\columnwidth}{!}{%
		\begin{tabular}{@{}cccccc@{}}
			\toprule
			\multirow{2}{*}{Point} & \multicolumn{3}{c}{Test {[}mm{]}} & \multicolumn{1}{l}{\multirow{2}{*}{Average {[}mm{]}}} & \multicolumn{1}{l}{\multirow{2}{*}{$\sigma$ {[}mm{]}}} \\ \cmidrule(lr){2-4}
			& 1         & 2         & 3         & \multicolumn{1}{l}{}                                  & \multicolumn{1}{l}{}                                   \\ \midrule
			1                      & 6.27      & 6.48      & 6.77      & 6.51                                                  & 0.21                                                   \\
			2                      & 8.86      & 5.64      & 5.29      & 6.60                                                  & 1.61                                                   \\
			3                      & 7.75      & 7.88      & 7.87      & 7.84                                                  & 0.06                                                   \\
			4                      & 6.84      & 6.70      & 6.99      & 6.84                                                  & 0.12                                                   \\
			5                      & 6.89      & 5.64      & 5.29      & 5.94                                                  & 0.69                                                   \\ \bottomrule
		\end{tabular}%
	}
\end{table}
